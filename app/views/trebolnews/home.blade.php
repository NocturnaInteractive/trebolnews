                                    ...
                                    <div class="infoplanes">
                                        ...
                                        ?>
                                            <div class="{{$class.'info'}}">
                                                <h4><span class="hastaplan">Hasta</span><img src="{{ asset('home/imagenes/plane'.$icon.'.png') }}" width="18px" height="18px" alt="icono">{{$plan->envios}}<br/><span class="hastaenv"> Envios</span><span class="precioplan">&nbsp;<span class="moneda"></span>{{$plan->precio}}</span></h4>
                                            </div>
                                        <?php
                                        ...
                                        ?>
                                        <div class="verdeinfo">
                                            <h4><span class="hastaplan">M&aacute;s</span><img src="{{ asset('imagenes/plane'.$icon.'.png') }}" width="18px" height="18px" alt="icono">100.000<span class="hastaenv"> Envios</span><span class="precioplan">&nbsp;<span class="moneda"></span>0</span></h4>
                                        </div>
                                    </div><!--infoplanes-->
                                    <div class="bot">
