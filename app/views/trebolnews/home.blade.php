...
<html lang="es-ES" class="no-js">
    ...
    <body>
        ...
        <div class="infoplanes">
        <div class="verdeinfo">
        <h4><span class="hastaplan">Hasta</span><img src="{{ asset('imagenes/plane.png') }}" width="18px" height="18px" alt="icono">2.500<span class="hastaenv"> Envios</span><span class="precioplan">&nbsp;$0</span></h4>
        </div>
        <div class="grisinfo">
        <h4><span class="hastaplan">Hasta</span><img src="{{ asset('imagenes/planegris.png') }}" width="18px" height="18px" alt="icono">5.000<span class="hastaenv"> Envios</span><span class="precioplan">&nbsp;$0</span></h4>
        </div>
        <div class="verdeinfo">
        <h4><span class="hastaplan">Hasta</span><img src="{{ asset('imagenes/plane.png') }}" width="18px" height="18px" alt="icono">10.000<span class="hastaenv"> Envios</span><span class="precioplan">&nbsp;$0</span></h4>
        </div>
        <div class="grisinfo">
        <h4><span class="hastaplan">Hasta</span><img src="{{ asset('imagenes/planegris.png') }}" width="18px" height="18px" alt="icono">20.000<span class="hastaenv"> Envios</span><span class="precioplan">&nbsp;$0</span></h4>
        </div>
        <div class="verdeinfo">
        <h4><span class="hastaplan">Hasta</span><img src="{{ asset('imagenes/plane.png') }}" width="18px" height="18px" alt="icono">25.000<span class="hastaenv"> Envios</span><span class="precioplan">&nbsp;$0</span></h4>
        </div>
        <div class="grisinfo">
        <h4><span class="hastaplan">Hasta</span><img src="{{ asset('imagenes/planegris.png') }}" width="18px" height="18px" alt="icono">50.000<span class="hastaenv"> Envios</span><span class="precioplan">&nbsp;$0</span></h4>
        </div>
        <div class="verdeinfo">
        <h4><span class="hastaplan">Hasta</span><img src="{{ asset('imagenes/plane.png') }}" width="18px" height="18px" alt="icono">100.000<span class="hastaenv"> Envios</span><span class="precioplan">&nbsp;$0</span></h4>
        </div>
        <div class="grisinfo">
        <h4><span class="hastaplan">M&aacute;s</span><img src="{{ asset('imagenes/planegris.png') }}" width="18px" height="18px" alt="icono">100.000<span class="hastaenv"> Envios</span><span class="precioplan">&nbsp;$0</span></h4>
        </div>
        </div><!--infoplanes-->
        <div class="bot">
        ...
        <div class="verdeinfo">
        <h4><span class="hastaplan">Hasta</span><img src="{{ asset('imagenes/plane.png') }}" width="18px" height="18px" alt="icono">50.000<span class="hastaenv"> Envios</span><span class="precioplan">&nbsp;$0</span></h4>
        </div>
        <div class="grisinfo">
        <h4><span class="hastaplan">Hasta</span><img src="{{ asset('imagenes/planegris.png') }}" width="18px" height="18px" alt="icono">100.000<span class="hastaenv"> Envios</span><span class="precioplan">&nbsp;$0</span></h4>
        </div>
        <div class="verdeinfo">
        <h4><span class="hastaplan">M&aacute;s</span><img src="{{ asset('imagenes/plane.png') }}" width="18px" height="18px" alt="icono">100.000<span class="hastaenv"> Envios</span><span class="precioplan">&nbsp;$0</span></h4>
        </div>
        <div class="grisinfo"><img class="xicon" src="{{ asset('imagenes/cruzicongris.png') }}" width="38px" height="38px" alt="icono"></div>
        </div><!--infoplanes-->
        </div><!--mensuales-->
