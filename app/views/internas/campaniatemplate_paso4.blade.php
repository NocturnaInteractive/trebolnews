...
<html lang="es-ES" class="no-js">
	<head>
		...
		<title>TrebolNEWS / Emails Predise&ntilde;ados</title>
...
<div id="menu" class="cbp-fbscroller" >
 ...
 <div id="container">
  ...
  <tr>
    ...
    <th scope="col" width="25px"><a class="temple_ver" href="detalle_template.html">ver</a></th>
    </tr>
    <tr><td colspan="3"><a class="temple_img" href="#"><label for="radio1"><img src="{{ asset('internas/imagenes/template-1.jpg') }}" width="150" height="190"></label></a></td></tr>
    </table>
    </td>
    ...
    <tr><td colspan="3"><a class="temple_img" href="#"><label for="radio2"><img src="{{ asset('internas/imagenes/template-2.jpg') }}" width="150" height="190"></label></a></td></tr>
    </table>
    </td>
    ...
    <tr><td colspan="3"><a class="temple_img" href="#"><label for="radio3"><img src="{{ asset('internas/imagenes/template-3.jpg') }}" width="150" height="190"></label></a></td></tr>
    </table>
    </td>
    ...
    <tr><td colspan="3"><a class="temple_img" href="#"><label for="radio4"><img src="{{ asset('internas/imagenes/template-4.jpg') }}" width="150" height="190"></label></a></td></tr>
    </table>
    </td>
    ...
    <tr><td colspan="3"><a class="temple_img" href="#"><label for="radio5"><img src="{{ asset('internas/imagenes/template-5.jpg') }}" width="150" height="190"></label></a></td></tr>
    </table>
    </td>
  </tr>
  ...
  <td>
    ...
    <tr><td colspan="3"><a class="temple_img" href="#"><label for="radio6"><img src="{{ asset('internas/imagenes/template-5.jpg') }}" width="150" height="190"></label></a></td></tr>
    </table>
    </td>
  ...
  <td>
    ...
    <tr><td colspan="3"><a class="temple_img" href="#"><label for="radio7"><img src="{{ asset('internas/imagenes/template-3.jpg') }}" width="150" height="190"></label></a></td></tr>
    </table>
    </td>
  ...
  <td>
    ...
    <tr><td colspan="3"><a class="temple_img" href="#"><label for="radio8"><img src="{{ asset('internas/imagenes/template-2.jpg') }}" width="150" height="190"></label></a></td></tr>
    </table>
    </td>
  ...
  <td>
    ...
    <tr><td colspan="3"><a class="temple_img" href="#"><label for="radio9"><img src="{{ asset('internas/imagenes/template-1.jpg') }}" width="150" height="190"></label></a></td></tr>
    </table>
    </td>
  ...
  <td>
    ...
    <tr><td colspan="3"><a class="temple_img" href="#"><label for="radio10"><img src="{{ asset('internas/imagenes/template-4.jpg') }}" width="150" height="190"></label></a></td></tr>
    </table>
    </td>
  </tr>
  </table>
