...
<div id="container">
			...
			<section class="tabs">
              ...
              <li><a class="crearlista" href="#" popup="crearlista">CREAR LISTA</a></li>
              </ul>
              <div class="cleaner"></div>
              </div><!--submenu-->
  ...
  @foreach($listas = Lista::where('id_usuario', '=', Auth::user()->id)->paginate(10) as $lista)
  <tr>
    <td>
     <form class="checkbox">
    ...
    <td><a href="{{ url('suscriptores/' . $lista->id) }}">{{ $lista->nombre }}</a></td>
    ...
    <td>
      ...
      <a class="editarcampam" href="#" ajax="{{ url('popup_editar_lista' . '/' . $lista->id) }}">
        <img src="{{ asset('internas/imagenes/editarcamania.png') }}" alt="editar campa&ntilde;a" width="25" height="25">
      </a>
      <a class="borrarcam" href="#" ajax="{{ url('popup_eliminar_lista' . '/' . $lista->id) }}">
