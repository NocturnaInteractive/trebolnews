...
<table width="100%"  cellpadding="0" cellspacing="0" class="perfiltabla">
          ...
          <th class="datoperfil" scope="col" width="684px">{{ $campania->nombre }}</th>
          </tr>
              <tr>
              <td class="tipoperfil">Asunto:</td>
              <td class="datoperfil">{{ $campania->asunto }}</td>
          </tr>
              <tr>
            <td class="tipoperfil">Nombre del Remitente:</td>
              <td class="datoperfil">{{ $campania->remitente }}</td>
          </tr>
              <tr>
            <td class="tipoperfil">Email del Remitente:</td> {{-- existe class="cont_faltante" --}}
              <td class="datoperfil">{{ $campania->email }}</td>
          </tr>
              <tr>
            <td class="tipoperfil">Email de Respuesta:</td>
              <td class="datoperfil">{{ $campania->respuesta }}</td>
          </tr>
</table>
...
<table width="100%"  cellpadding="0" cellspacing="0" class="listacampanias">
  ...
  @foreach($campania->listas as $list)
  <?php $lista = Lista::find($list->id) ?>
  <tr>
    <td>{{ $lista->nombre }}</td>
...
<tr><td>{{ $campania->contenido }}</td></tr>
</table>
...
<li><a href="{{ route('campanias') }}" id="siguiente" class="btn_guardar" y="confirmar">
  ...
  ENVIAR
  @elseif($campania->envio == 'programado')
  PROGRAMAR
  @endif
</a></li>
</ul>
