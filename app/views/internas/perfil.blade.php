...
<div id="container">
			...
			<section class="tabs">
              ...
              <tr class="primeraperfil">
   			  <th scope="col" width="200px" class="tipoperfil">Nombre y Apellido:</th>
    		  <th class="datoperfil" scope="col" width="684px">{{ Auth::user()->nombre . ' ' . Auth::user()->apellido }}</th>
   			  </tr>
              <tr>
              <td class="tipoperfil">Tel&eacute;fono:</td>
              <td class="datoperfil">{{ Auth::user()->telefono }}</td>
  			  </tr>
              <tr>
        	  <td class="tipoperfil">Email:</td>
              <td class="datoperfil">{{ Auth::user()->email }}</td>
  			  </tr>
              <tr>
        	  <td class="tipoperfil">Empresa:</td>
              <td class="datoperfil">{{ Auth::user()->empresa }}</td>
  			  </tr>
              <tr>
        	  <td class="tipoperfil">Ciudad y Pa&iacute;s:</td>
              <td class="datoperfil">{{ (Auth::user()->ciudad && Auth::user()->pais) ? Auth::user()->ciudad . ', ' . Auth::user()->pais : '' }}</td>
  			  </tr>
              </table>
        ...
        <div class="infocont">
    		  ...
    		  <th class="datoperfil" scope="col" width="504px">Nocturna</th>
   			  </tr>
              <tr>
              <td class="tipoperfil">CUIT Empresa:</td>
              <td class="datoperfil">22-5555741713-4</td>
  			  </tr>
              <tr>
        	  <td class="tipoperfil">Tipo de factura:</td>
              <td class="datoperfil">Tipo "A"</td>
  			  </tr>
              <tr>
              <td class="tipoperfil">Tel&eacute;fono:</td>
              <td class="datoperfil">(011) 555-1713</td>
  			  </tr>
              <tr>
        	  <td class="tipoperfil">Direcci&oacute;n de facturaci&oacute;n:</td>
              <td class="datoperfil">Juana Azurduy N&deg;1713</td>
  			  </tr>
              <tr>
        	  <td class="tipoperfil">C&oacute;digo postal:</td>
              <td class="datoperfil">2385</td>
  			  </tr>
              <tr>
        	  <td class="tipoperfil">Ciudad y Pa&iacute;s.</td>
              <td class="datoperfil">Buenos Aires - Argentina</td>
  			  </tr>
              <tr>
              <td class="tipoperfil">Nombre de la persona responsable:</td>
              <td class="datoperfil">Juan Carlos Ertchert</td>
  			  </tr>
              <tr>
        	  <td class="tipoperfil">Email del responsable:</td>
              <td class="datoperfil">juanertchert@ejemplo.com</td>
  			  </tr>

              </table>

              <div class="editarperfil">
              <a href="{{ route('editar_perfil') }}">EDITAR</a>
              </div>
